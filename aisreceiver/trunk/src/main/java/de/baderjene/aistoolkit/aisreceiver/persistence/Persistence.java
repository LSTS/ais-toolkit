...
/**
 * The persistence class is used to store AIS messages to the database and to
...
public class Persistence {
	...
	/**
	 * Get the latest position report which occured within the last five minutes
	 * from each vessel.
	 * 
	...
	/**
	 * Deletes all position reports that are older than 24 hours. It is
	 * triggered by a cron scheduler every three hours.
	 */
	public void cleanup() {
		final Session session = factory.getCurrentSession();
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<PositionReport> getShipStatusByVesselName(
